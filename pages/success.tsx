...
function Success({ products }: Props) {
  ...
  return (
    <div className=" text-slate-100 bg-[#2e2b3d]">
      <Head>
      ...
      <header className="mx-auto max-w-xl">
        <Link href="/">
          <div className="relative ml-4 h-16 w-8 cursor-pointer transition lg:hidden">
            <Image
              src="https://raw.githubusercontent.com/Terra-01/Terra-01/main/Assets/Apple-rainbow.png"
              layout="fill"
              objectFit="contain"
            />
          </div>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-9">
        <section className="order-2 mx-auto max-w-xl h-screen pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
          <Link href="/">
          ...
          <div className="my-8 ml-4 flex space-x-4 lg:ml-14 xl:ml-0">
            <div className="flex h-11 w-11 items-center justify-center rounded-full border-2 border-slate-300">
          ...
          <div className="mx-4 divide-y divide-slate-600 rounded-md border border-slate-600 p-4 lg:ml-14">
            ...
            <div className="pt-3 text-sm">
              ...
              <p className="text-gray-400">CNB21441622</p>
            </div>
          </div>

          <div className="my-4 mx-4 space-y-2 rounded-md border border-slate-600 p-4 lg:ml-14">
            <p>Order updates</p>
            <p className="text-sm text-gray-400">
        ...
        {mounted && (
          <section className="overflow-y-scroll border-y border-l border-gray-300 bg-[#373346] lg:order-2 lg:col-span-4 lg:h-screen lg:border-y-0">
            <div
              className={`w-full ${
            ...
            {showOrderSummaryCondition && (
              <div className="mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0 lg:max-w-lg lg:px-10 lg:py-16">
                ...
                <div className="flex justify-between pt-4">
                  <p>Total</p>
                  <p className="flex items-center gap-x-2 text-xs text-slate-300">
                    USD
